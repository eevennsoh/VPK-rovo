...
test("convertBareAppMentionsToTokens prefers the longest matching alias", () => {
	...
	assert.equal(
		convertBareAppMentionsToTokens("Open @Google Drive and @Google.", overlappingAliases),
		"Open @[app:google-drive] and @[app:google].",
	);
});
