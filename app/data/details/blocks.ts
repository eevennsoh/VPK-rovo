...
<EditorPalette variant="flat" />`,
		...
		examples: [
			...
			{ title: "Search", description: "A category-specific inline search picker with a sticky \"Browse all\" footer.", demoSlug: "editor-palette-search" },
		],
	},
	"editor-toolbar": {
