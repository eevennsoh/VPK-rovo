...
// Kanban hosts overwrite columnFrame from columnChrome.`,
	...
	props: [
		...
		},
		{
			...
			default: "false",
			description:
				"Enables the stacked entrance, bottom depth tail, extended scroll fade, and animated end summary.",
		},
		{
			name: "emptyLabel",
			type: "string",
		...
		},
		{
			...
			default: '"circle"',
			description:
				'Collapsed marker treatment. "circle" renders 4px human-avatar dots; reviewed rest in `icon.disabled` and newly synced rest in `color.icon`; they grow with gradual neighbor falloff to a 12px maximum and reveal the face on hover or focus. "line" preserves the original horizontal marks, length falloff, and tone treatment.',
		},
		{
			...
			default: '"column"',
			description:
				'Use "gutter" for the count-hidden, top-aligned compact rail. The expand control remains keyboard-reachable. Newly synced sessions reveal the running total with the digit-slot morph; `"column"` (hover-embed, catalog, or panel) keeps that total visible.',
		},
		{
