...
// Kanban hosts overwrite columnFrame from columnChrome.`,
	...
	props: [
		...
		},
		{
			...
			default: '"column"',
			description:
				'Use "gutter" for the count-hidden, top-aligned compact rail. The expand control remains keyboard-reachable. `"column"` (catalog or panel) keeps that total visible. The in-flow board keeps `"gutter"` while the rail is collapsed, including the hover preview.',
		},
		{
