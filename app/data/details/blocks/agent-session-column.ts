...
// Kanban hosts overwrite columnFrame from columnChrome.`,
	...
	props: [
		...
		},
		{
			...
			default: '"column"',
			description:
				'Use "gutter" for the count-free, top-aligned compact rail. The expand control remains keyboard-reachable.',
		},
		{
