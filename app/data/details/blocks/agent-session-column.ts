...
// Kanban hosts overwrite columnFrame from columnChrome.`,
	...
	props: [
		...
		},
		{
			...
			default: '"column"',
			description:
				'Use "gutter" for the top-aligned compact rail that hides the count at rest. The expand control remains keyboard-reachable. `"column"` (catalog or panel) keeps that total visible. The in-flow board keeps `"gutter"` while the rail is collapsed; the hover-scaled hit area reveals the same header count.',
		},
		{
