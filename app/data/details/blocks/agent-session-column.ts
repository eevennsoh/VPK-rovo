...
// The board omits headerSurface — it defaults to "column".`,
	props: [
		...
		},
		{
			...
			description:
				"Enables hover select, the Selected N header, and bulk Link / Create / Archive / Clear. Omit it and the column stays a read-only list with Resume and Hide. `locateTarget` is the only lookup — `attach` consumes that value.",
		},
		{
