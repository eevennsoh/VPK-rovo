...
// Kanban hosts overwrite columnFrame from columnChrome.`,
	...
	props: [
		...
		},
		{
			...
			default: '"column"',
			description:
				'Use "gutter" for the count-free, top-aligned compact rail. The expand control remains keyboard-reachable. Gutter rest can still count unread as +N if a head is shown; `"column"` (hover-embed, catalog, or panel) increments the session total instead.',
		},
		{
