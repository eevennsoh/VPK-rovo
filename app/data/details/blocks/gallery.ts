...
<Gallery items={items} open={open} onOpenChange={setOpen} />`,
	props: [
		{ name: "items", type: "readonly GalleryItem[]", required: true, description: "Cards to render in the dock. Each item has an id, title, description, size (\"tall\" | \"square\" | \"wide\"), and a decorative surfaceClassName gradient." },
