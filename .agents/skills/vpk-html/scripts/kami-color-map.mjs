...
export const KAMI_COLOR_MAP = {
	...
	"#EEF2F7": "var(--ill-tone1)",
	"#eef2f7": "var(--ill-tone1)",
	"#E4ECF5": "var(--ill-tone1)",
	"#e4ecf5": "var(--ill-tone1)",
	"#D0DCE9": "var(--ill-tone2)",
	"#D6E1EE": "var(--ill-tone2)",
	"#e8e6dc": "var(--rule)",
	"#E8E6DC": "var(--rule)",
	"#e8e7e1": "var(--rule)",
	"#E8E7E1": "var(--rule)",
	...
	"rgba(250, 249, 245, 0.12)": "color-mix(in srgb, var(--paper) 12%, transparent)",
	"rgba(227,218,204,0.35)": "color-mix(in srgb, var(--ill-tone1) 35%, transparent)",
	"rgba(227, 218, 204, 0.35)": "color-mix(in srgb, var(--ill-tone1) 35%, transparent)",
	...
	"rgba(0,0,0,0.05)": "color-mix(in srgb, var(--ink) 5%, transparent)",
	"rgba(1B365D, 0.08)": "color-mix(in srgb, var(--focal) 8%, transparent)",
	"rgba(1B365D,0.08)": "color-mix(in srgb, var(--focal) 8%, transparent)",
};
