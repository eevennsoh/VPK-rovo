...
| `GET` | `/api/vpk-html` | no | `backend/routes/vpk-html.js:406` |
| `GET` | `/api/vpk-html/*assetPath` | no | `backend/routes/vpk-html.js:407` |
| `POST` | `/api/vpk-html/apply-tokens` | no | `backend/routes/vpk-html.js:299` |
| `GET` | `/api/vpk-html/notes` | no | `backend/routes/vpk-html.js:324` |
| `PUT` | `/api/vpk-html/notes` | no | `backend/routes/vpk-html.js:345` |
| `POST` | `/api/vpk-html/publish-gist` | no | `backend/routes/vpk-html.js:372` |
