...
import {
	...
	PersonRowField,
	PriorityRowField,
} from "@/components/blocks/jira-work-item/experimental-v5/components/detail-field-editors";
...
/** The ArtifactPane-aligned Details body for the experimental v5 work item. */
