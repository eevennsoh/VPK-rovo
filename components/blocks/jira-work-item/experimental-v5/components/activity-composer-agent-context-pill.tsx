...
import { WorkItemAgentSelector } from "@/components/blocks/jira-work-item/experimental-v5/components/work-item-agent-selector";
import { DEFAULT_PINNED_SPACE_AGENT_IDS } from "@/components/blocks/jira-work-item/experimental-v5/lib/work-item-picker-options";
import { WORK_ITEM_AGENT_SELECTOR_MENU } from "@/components/blocks/jira-work-item/experimental-v5/lib/work-item-agent-selector-menu";
import {
	DropdownMenu,
	DropdownMenuContent,
	DropdownMenuTrigger,
