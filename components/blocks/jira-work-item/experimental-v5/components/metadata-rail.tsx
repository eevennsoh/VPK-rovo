...
} from "@/components/blocks/jira-work-item/experimental-v5/components/automation-tab";
import { DevelopmentSectionContent } from "@/components/blocks/jira-work-item/experimental-v5/components/details-sections";
import { DetailsTab } from "@/components/blocks/jira-work-item/experimental-v5/components/details-tab";
import {
...
import { CONNECTED_REPOSITORY_COUNT } from "@/components/blocks/jira-work-item/experimental-v5/lib/development-repositories";
import { getPullRequestIdentity } from "@/components/blocks/jira-work-item/experimental-v5/lib/jira-activity-adapter";
import type {
	PullRequestCheck,
	PullRequestReviewer,
...
const PullRequestContextRail = dynamic(
	() => import("@/components/blocks/jira-work-item/experimental-v5/components/pull-request-detail/pull-request-context-rail")
