...
import { ActivityChatCommentsProvider } from "@/components/blocks/jira-work-item/experimental-v5/context-activity-chat-comments";
import {
	FailingChecksComposerProvider,
	useFailingChecksComposer,
} from "@/components/blocks/jira-work-item/experimental-v5/context-failing-checks-composer";
import {
...
import {
	...
	useMetadataRail,
} from "@/components/blocks/jira-work-item/experimental-v5/context-metadata-rail";
import { PanelLayoutProvider } from "@/components/blocks/jira-work-item/experimental-v5/context-panel-layout";
import {
	SectionNavigationProvider,
	usePublishInsightsCount,
	useSectionNavigation,
} from "@/components/blocks/jira-work-item/experimental-v5/context-section-navigation";
import { ExperimentalWorkItemDialog } from "@/components/blocks/jira-work-item/experimental-v5/components/experimental-work-item-dialog";
import { ExperimentalWorkItemLayout } from "@/components/blocks/jira-work-item/experimental-v5/components/experimental-work-item-layout";
import { ContextPanel } from "@/components/blocks/jira-work-item/experimental-v5/components/context-panel";
import { ContextResources } from "@/components/blocks/jira-work-item/experimental-v5/components/context-resources";
import { PullRequestsSelect } from "@/components/blocks/jira-work-item/experimental-v5/components/pull-requests-select";
import { WorkItemSectionNav } from "@/components/blocks/jira-work-item/experimental-v5/components/work-item-section-nav";
import { WorkItemSidePanelResizeHandle } from "@/components/blocks/jira-work-item/experimental-v5/components/work-item-side-panel-resize-handle";
import { ActivityPanel } from "@/components/blocks/jira-work-item/experimental-v5/components/activity-panel";
import {
	ActivityComposer,
	type ActivityComposerPullRequestFix,
	type ActivityComposerPullRequestReview,
} from "@/components/blocks/jira-work-item/experimental-v5/components/activity-composer";
...
import { MetadataRail } from "@/components/blocks/jira-work-item/experimental-v5/components/metadata-rail";
import { FloatingSessionSurface } from "@/components/blocks/jira-work-item/experimental-v5/components/floating-session-surface";
import type { SessionReplyInterceptor } from "@/components/blocks/jira-work-item/experimental-v5/components/floating-session-surface";
import type { CodingAgentId } from "@/components/blocks/jira-work-item/experimental-v5/components/context-title-actions";
import type { WorkItemAutomationRule } from "@/components/blocks/jira-work-item/experimental-v5/components/automation-tab";
import {
...
} from "@/components/blocks/jira-work-item/experimental-v5/lib/layout-constants";
import {
	getPullRequestIdentity,
	selectPullRequestEntries,
	type ActivitySessionThreadConfig,
} from "@/components/blocks/jira-work-item/experimental-v5/lib/jira-activity-adapter";
import { buildPullRequestFixComposerPrompt } from "@/components/blocks/jira-work-item/experimental-v5/lib/failing-checks-composer-context";
import {
	resolvePullRequestDetailData,
	type PullRequestActivity,
	type PullRequestCheck,
	type PullRequestReviewer,
} from "@/components/blocks/jira-work-item/experimental-v5/lib/pull-request-detail-data";
import {
	createSubmittedPullRequestReviewActivity,
	mapReviewVerdictToReviewerStatus,
	PULL_REQUEST_REVIEW_TOASTER_ID,
} from "@/components/blocks/jira-work-item/experimental-v5/lib/pull-request-review-submit";
import { showPullRequestReviewToast } from "@/components/blocks/jira-work-item/experimental-v5/lib/show-pull-request-review-toast";
import { resolveInitialReviewedChapterIds } from "@/components/blocks/jira-work-item/experimental-v5/lib/resolve-initial-reviewed-chapter-ids";
import { resolveNewInsightsCount } from "@/components/blocks/jira-work-item/experimental-v5/lib/new-insights-count";
import { useSidebarResize } from "@/components/projects/rovo-core/hooks/use-sidebar-resize";
import { Toaster } from "@/components/ui/sonner";

interface ExperimentalV5JiraWorkItemBaseProps {
...
export type ExperimentalV5JiraWorkItemProps = ExperimentalV5JiraWorkItemBaseProps & (
...
interface ExperimentalV5JiraWorkItemContentProps {
	activitySessionThread?: ActivitySessionThreadConfig;
	autoOpenPullRequestIdentity?: string | null;
	automationRules?: readonly WorkItemAutomationRule[];
	composerAgents?: readonly AgentSelectorAgent[];
...
function ExperimentalV5JiraWorkItemContent({
	...
	stageKey,
	workItem,
}: Readonly<ExperimentalV5JiraWorkItemContentProps>) {
...
/**
 * Composition root for the experimental v5 Jira Work Item surface.
 *
 ...
 */
export function ExperimentalV5JiraWorkItem(props: Readonly<ExperimentalV5JiraWorkItemProps>) {
			...
			>
				...
				>
					<ActivityChatCommentsProvider>
						<FailingChecksComposerProvider>
							<ExperimentalV5JiraWorkItemContent
...
export default ExperimentalV5JiraWorkItem;
