...
import { useActivityChatComments } from "@/components/blocks/jira-work-item/experimental-v6/context-activity-chat-comments";
import { useJiraWorkItem } from "@/components/blocks/jira-work-item/experimental-v6/context-jira-work-item";
import { useMetadataRail } from "@/components/blocks/jira-work-item/experimental-v6/context-metadata-rail";
		...
		>
			<div ref={activityRootRef} className="min-w-0 max-w-full" data-jira-work-item-activity>
				<JiraActivity
					...
					className="min-w-0 gap-4 [&_[data-jira-activity-entry-id=team-eu-annie-visuals]>div:last-child]:rounded-lg [&_[data-jira-activity-entry-id=team-eu-annie-visuals]>div:last-child]:border [&_[data-jira-activity-entry-id=team-eu-annie-visuals]>div:last-child]:border-border [&_[data-jira-activity-entry-id=team-eu-annie-visuals]>div:last-child]:bg-surface [&_[data-jira-activity-entry-id=team-eu-annie-visuals]>div:last-child]:p-3 [&_[data-jira-activity-entry-id=team-eu-marcus-budget]>div:last-child]:rounded-lg [&_[data-jira-activity-entry-id=team-eu-marcus-budget]>div:last-child]:border [&_[data-jira-activity-entry-id=team-eu-marcus-budget]>div:last-child]:border-border [&_[data-jira-activity-entry-id=team-eu-marcus-budget]>div:last-child]:bg-surface [&_[data-jira-activity-entry-id=team-eu-marcus-budget]>div:last-child]:p-3"
					composer={null}
