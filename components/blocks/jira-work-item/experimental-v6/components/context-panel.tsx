...
import { InsightsPanel } from "@/components/blocks/jira-work-item/experimental-v6/components/insights-panel";
import { InsightsWorkItemSplit } from "@/components/blocks/jira-work-item/experimental-v6/components/insights-work-item-split";
import { WorkItemBody } from "@/components/blocks/jira-work-item/experimental-v6/components/work-item-body";
import { useSectionNavigation } from "@/components/blocks/jira-work-item/experimental-v6/context-section-navigation";
import { getPullRequestIdentity } from "@/components/blocks/jira-work-item/experimental-v6/lib/jira-activity-adapter";
import type { PullRequestActivity } from "@/components/blocks/jira-work-item/experimental-v6/lib/pull-request-detail-data";
...
const PullRequestDetailView = dynamic(
	() => import("@/components/blocks/jira-work-item/experimental-v6/components/pull-request-detail/pull-request-detail-view")
