...
import { ActivityChatCommentsProvider } from "@/components/blocks/jira-work-item/experimental-v6/context-activity-chat-comments";
import {
	FailingChecksComposerProvider,
	useFailingChecksComposer,
} from "@/components/blocks/jira-work-item/experimental-v6/context-failing-checks-composer";
import {
...
import {
	...
	useMetadataRail,
} from "@/components/blocks/jira-work-item/experimental-v6/context-metadata-rail";
import { PanelLayoutProvider } from "@/components/blocks/jira-work-item/experimental-v6/context-panel-layout";
import {
	SectionNavigationProvider,
	usePublishInsightsCount,
	useSectionNavigation,
} from "@/components/blocks/jira-work-item/experimental-v6/context-section-navigation";
import { ExperimentalWorkItemDialog } from "@/components/blocks/jira-work-item/experimental-v6/components/experimental-work-item-dialog";
import { ExperimentalWorkItemLayout } from "@/components/blocks/jira-work-item/experimental-v6/components/experimental-work-item-layout";
import { ContextPanel } from "@/components/blocks/jira-work-item/experimental-v6/components/context-panel";
import { ContextResources } from "@/components/blocks/jira-work-item/experimental-v6/components/context-resources";
import { PullRequestsSelect } from "@/components/blocks/jira-work-item/experimental-v6/components/pull-requests-select";
import { WorkItemSectionNav } from "@/components/blocks/jira-work-item/experimental-v6/components/work-item-section-nav";
import { WorkItemSidePanelResizeHandle } from "@/components/blocks/jira-work-item/experimental-v6/components/work-item-side-panel-resize-handle";
import { ActivityPanel } from "@/components/blocks/jira-work-item/experimental-v6/components/activity-panel";
import {
	ActivityComposer,
	type ActivityComposerPullRequestFix,
	type ActivityComposerPullRequestReview,
} from "@/components/blocks/jira-work-item/experimental-v6/components/activity-composer";
...
import { MetadataRail } from "@/components/blocks/jira-work-item/experimental-v6/components/metadata-rail";
import { FloatingSessionSurface } from "@/components/blocks/jira-work-item/experimental-v6/components/floating-session-surface";
import type { SessionReplyInterceptor } from "@/components/blocks/jira-work-item/experimental-v6/components/floating-session-surface";
import type { CodingAgentId } from "@/components/blocks/jira-work-item/experimental-v6/components/context-title-actions";
import type { WorkItemAutomationRule } from "@/components/blocks/jira-work-item/experimental-v6/components/automation-tab";
import {
...
} from "@/components/blocks/jira-work-item/experimental-v6/lib/layout-constants";
import {
...
import { buildPullRequestFixComposerPrompt } from "@/components/blocks/jira-work-item/experimental-v6/lib/failing-checks-composer-context";
import {
...
} from "@/components/blocks/jira-work-item/experimental-v6/lib/pull-request-review-submit";
import { showPullRequestReviewToast } from "@/components/blocks/jira-work-item/experimental-v6/lib/show-pull-request-review-toast";
import { resolveInitialReviewedChapterIds } from "@/components/blocks/jira-work-item/experimental-v6/lib/resolve-initial-reviewed-chapter-ids";
import { resolveNewInsightsCount } from "@/components/blocks/jira-work-item/experimental-v6/lib/new-insights-count";
import { useSidebarResize } from "@/components/projects/rovo-core/hooks/use-sidebar-resize";
import { Toaster } from "@/components/ui/sonner";
import {
	createTeamEuVitaOneState,
	TEAM_EU_VITA_ONE_WORK_ITEM,
} from "@/components/blocks/jira-work-item/experimental-v6/data/team-eu-vita-one";

interface ExperimentalV6JiraWorkItemBaseProps {
...
export type ExperimentalV6JiraWorkItemProps = ExperimentalV6JiraWorkItemBaseProps & (
...
interface ExperimentalV6JiraWorkItemContentProps {
	activitySessionThread?: ActivitySessionThreadConfig;
	autoOpenPullRequestIdentity?: string | null;
	automationRules?: readonly WorkItemAutomationRule[];
	composerAgents?: readonly AgentSelectorAgent[];
...
function ExperimentalV6JiraWorkItemContent({
	...
	stageKey,
	workItem,
}: Readonly<ExperimentalV6JiraWorkItemContentProps>) {
						...
						<ExperimentalWorkItemLayout
							...
							metadata={(
								<div
									...
									className="group/metadata-resize relative flex min-h-0 min-w-0 flex-none self-start flex-col overflow-hidden rounded-lg border border-border bg-surface-raised"
 ...
 */
export function ExperimentalV6JiraWorkItem(props: Readonly<ExperimentalV6JiraWorkItemProps>) {
	...
	const workItem = props.workItem ?? TEAM_EU_VITA_ONE_WORK_ITEM;
	const resolvedInitialState = useMemo(
		() => initialState ?? createTeamEuVitaOneState(initialPreset, workItem),
			...
			>
				...
				>
					<ActivityChatCommentsProvider>
						<FailingChecksComposerProvider>
							<ExperimentalV6JiraWorkItemContent
...
export default ExperimentalV6JiraWorkItem;
