...
import {
	...
	PersonRowField,
	PriorityRowField,
} from "@/components/blocks/jira-work-item/experimental-v4/components/detail-field-editors";
...
/** The ArtifactPane-aligned Details body for the experimental v4 work item. */
