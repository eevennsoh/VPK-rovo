/**
 * Deterministic AI Planner state for the experimental Jira Work Item block.
 *
...
import { LABEL_OPTIONS, PROJECT_OPTIONS } from "@/components/blocks/jira-work-item/data/metadata-fixtures";
import { METADATA_PEOPLE } from "@/components/blocks/jira-work-item/data/metadata-people";
import type { ThirdPartyLogoName } from "@/components/ui/data/logo-third-party-data";
import { filledContextResources } from "@/components/blocks/jira-work-item/data/session-fixtures";
import type {
...
export interface AgentPlannerProposal {
	context: JiraWorkItemContextResources;
...
function cloneContext(context: Readonly<JiraWorkItemContextResources>): JiraWorkItemContextResources {
	return {
		...context,
		tldr: [...context.tldr],
