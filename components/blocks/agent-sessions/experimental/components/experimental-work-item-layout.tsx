 ...
 * holds Metadata and scrolls independently.
 *
		...
		<div className="@container/agentlayout h-full min-h-0 min-w-0">
			...
			>
				<div className="contents @[860px]/agentlayout:flex @[860px]/agentlayout:min-h-0 @[860px]/agentlayout:min-w-0 @[860px]/agentlayout:flex-col">
					...
					<div className="order-4 min-w-0 sticky bottom-0 z-10 bg-surface-overlay px-4 pt-3 pb-4 @[860px]/agentlayout:static @[860px]/agentlayout:shrink-0 @[860px]/agentlayout:border-t @[860px]/agentlayout:border-border @[860px]/agentlayout:bg-surface-overlay @[860px]/agentlayout:px-6 @[860px]/agentlayout:py-4">
						{composer}
					</div>
				</div>
