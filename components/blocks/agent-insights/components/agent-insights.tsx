...
export type AgentInsightsProps = ComponentProps<"div">;

export function AgentInsights({ className, ...props }: Readonly<AgentInsightsProps>) {
	return (
		<div className={cn("h-full overflow-y-auto bg-surface-sunken", className)} {...props}>
