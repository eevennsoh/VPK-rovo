...
const WORK_ITEMS: readonly PulseWorkItem[] = [
	{
		key: "PAY-101",
		summary: "Inventory every v1 call site and name an owner for each",
	...
	{
		key: "PAY-102",
		summary: "Spike: can LegacyGatewayAdapter be deleted instead of ported?",
	...
	{
		key: "PAY-104",
		summary: "Port createPaymentIntent to the v2 client",
	...
	{
		key: "PAY-105",
		summary: "Port confirmPaymentIntent and the 3-D Secure challenge flow",
	...
	{
		key: "PAY-107",
		summary: "Move retry and backoff out of the adapter into payments-api",
	...
	{
		key: "PAY-109",
		summary: "Regenerate typed webhook payloads from the v2 OpenAPI spec",
	...
	{
		key: "PAY-112",
		summary: "sandbox-eu rejects v2 idempotency keys longer than 64 characters",
	...
	{
		key: "PAY-113",
		summary: "Contract tests for the 3-D Secure challenge path",
	...
	{
		key: "PAY-115",
		summary: "Migrate ledger-sync reconciliation to v2 settlement events",
	...
	{
		key: "PAY-118",
		summary: "Saved wallet UI for v2 payment methods",
	...
	{
		key: "PAY-119",
		summary: "Rollback rehearsal on payments-api staging",
	...
	{
		key: "PAY-121",
		summary: "payments_sdk_v2_rollout: targeting rules and per-account kill switch",
	...
	{
		key: "PAY-123",
		summary: "Map the v1 error taxonomy onto the eleven v2 decline reasons",
	...
	{
		key: "PAY-126",
		summary: "Delete LegacyGatewayAdapter and the 4,180 lines behind it",
	...
	{
		key: "PAY-128",
		summary: "Write the SDK version at settlement time, not at intent time",
		tags: [{ text: "ledger-sync", color: "magenta" }],
		priority: "medium",
		status: "To do",
	...
	{
		key: "PAY-130",
		summary: "Localise the eleven v2 decline strings into nine languages",
...
const LOOSE_WORK: readonly PulseLooseWork[] = [
	{
		id: "lw-scope-thread",
		title: "The adapter keep-or-delete argument",
		source: "Slack",
		detail: "38 messages in #payments-migration · the decision itself is not written down",
		memberIds: ["priya", "maya", "jordan"],
		suggestedAction: "Capture as a decision on PAY-101",
	},
	{
		id: "lw-adapter-branch",
		title: "Proof branch deleting the whole adapter",
		source: "GitHub",
		detail: "PR #1847 · 41 files, 4,180 deletions · no linked work item",
		memberIds: ["maya"],
		suggestedAction: "Link to PAY-102",
	},
	{
		id: "lw-loom-spike",
		title: "Walkthrough of what the spike actually found",
		source: "Loom",
		detail: "9 min · shared in a DM, never attached to the epic",
		memberIds: ["maya"],
		suggestedAction: "Attach to PAY-102",
	},
	{
		id: "lw-sandbox-triage",
		title: "Root cause of the sandbox 401s",
		source: "Slack",
		detail: "Found in thread at 10:52 · PAY-112 still reads “investigating”",
		memberIds: ["jordan", "review-agent"],
		suggestedAction: "Sync the summary to PAY-112",
	},
	{
		id: "lw-oncall-note",
		title: "On-call handover note on key truncation",
		source: "Confluence",
		detail: "Written at 03:10 Tuesday · sits in a personal space",
		memberIds: ["jordan"],
		suggestedAction: "Move under the PAY epic",
	},
	{
		id: "lw-night-prs",
		title: "Six agent pull requests merged overnight",
		source: "GitHub",
		detail: "#1862–#1867 · all green, none linked to a work item",
		memberIds: ["review-agent", "test-agent", "release-agent"],
		suggestedAction: "Bulk-link to PAY-105 and PAY-113",
	},
	{
		id: "lw-flag-edits",
		title: "Kill switch built straight in LaunchDarkly",
		source: "LaunchDarkly",
		detail: "3 targeting rules changed at 01:14 · no change record in Jira",
		memberIds: ["release-agent"],
		suggestedAction: "Attach the rule diff to PAY-121",
	},
	{
		id: "lw-figma-parked",
		title: "Wallet frames marked “parked, needs card artwork”",
		source: "Figma",
		detail: "The reason we cut it lives in a comment thread",
		memberIds: ["diego"],
		suggestedAction: "Record the cut on PAY-118",
	},
	{
		id: "lw-copy-doc",
		title: "Eleven decline strings, already read by legal",
		source: "Google Docs",
		detail: "Approved copy with no work item and no localisation ticket",
		memberIds: ["diego", "priya"],
		suggestedAction: "Link the doc to PAY-130",
	},
	{
		id: "lw-rehearsal-draft",
		title: "Rollback rehearsal run log",
		source: "Confluence",
		detail: "Draft page, four minutes eleven seconds recorded · not linked to the epic",
		memberIds: ["priya", "release-agent"],
		suggestedAction: "Publish and link to PAY-119",
	},
	{
		id: "lw-killswitch-loom",
		title: "How to flip the kill switch at 3am",
		source: "Loom",
		detail: "6 min recorded at 22:00 Sydney · only the two reviewers have the link",
		memberIds: ["maya"],
		suggestedAction: "Attach to PAY-121",
	},
	{
		id: "lw-p95-screenshot",
		title: "v2 is 42 ms faster at p95",
		source: "Slack",
		detail: "A screenshot in #payments-migration · changes the rollout argument, lives nowhere",
		memberIds: ["maya"],
		suggestedAction: "Add as a comment on PAY-126",
	},
];
