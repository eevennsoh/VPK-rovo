...
import { KnowledgeDirectoryDialog, type KnowledgeDirectorySkill } from "@/components/blocks/knowledge-directory";

const DEMO_SESSION_SKILLS: readonly KnowledgeDirectorySkill[] = [
	{
