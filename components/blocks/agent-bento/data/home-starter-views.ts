...
export const HOME_STARTER_VIEWS: Readonly<Record<HomeStarterCategory, ReadonlyArray<HomeStarterTemplate>>> = {
	...
	summarize: [
		...
		},
		{
			...
			prompt: "Build a Studio agent named Release Notes Drafter that summarizes up to 20 Jira work items, groups them into themes, and runs Draft release notes to produce clear notes in Confluence for stakeholders.",
