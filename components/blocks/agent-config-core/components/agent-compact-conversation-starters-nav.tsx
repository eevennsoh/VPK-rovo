...
import { AgentCompactNavMenuInitialHighlightReset, useCompactNavMenuNoInitialHighlight } from "@/components/blocks/agent-config-core/components/agent-compact-nav-menu";
import { AGENT_COMPACT_CONFIG_NAV_TRIGGER_CLASS, AgentCompactConfigNavButton, type AgentCompactConfigNavButtonItem } from "@/components/blocks/agent-config-core/components/agent-compact-config-nav-rows";
