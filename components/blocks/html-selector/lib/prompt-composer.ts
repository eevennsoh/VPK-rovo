...
export function composeVpkHtmlVideoPrompt({
	...
	const lines = [
		...
		`Write all generated video project files, captures, audio, and exports under artifacts/vpk-html/${slug}/.`,
		"Keep intermediate assets inside that artifact folder and report the final video/export path when finished.",
		"",
