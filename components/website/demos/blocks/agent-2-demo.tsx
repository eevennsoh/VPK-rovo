...
export function AgentDemo2Full() {
	const {
		addListValues,
		appendListItem,
		config,
...
export function AgentDemo2Empty() {
	const {
		addListValues,
		appendListItem,
		config,
...
export default function AgentDemo2() {
	return <AgentDemo2Full />;
}
