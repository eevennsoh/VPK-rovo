...
import { type CSSProperties, startTransition, useCallback, useEffect, useLayoutEffect, useMemo, useRef, useState, ViewTransition } from "react";
...
export function RovoAppShell({ embedded = false, initialThreadId = null }: Readonly<RovoAppShellProps>) {
	...
	// Returns to the "Agents" landing. Shared by the sidebar's "Agents"
	...
	// the pending selection (set when a template card is chosen, consumed +
	...
	const chatPaneContainer = (
		<div
			className={cn(
				...
				// Home landing stacks the composer + agents table + footer in a
