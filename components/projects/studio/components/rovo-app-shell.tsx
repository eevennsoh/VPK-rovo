	...
	analyze: [
		{
			...
			prompt: "Build a Rovo agent named Customer Insights that analyzes customer feedback from provided pages, links, or projects, then returns themes, needs, risks, and recommended actions.",
		...
		},
		{
			...
			prompt: "Build a Rovo agent named Jira Theme Analyzer that scans Jira work items from a JQL query, search results, or project context, then identifies themes and recommends epic groupings.",
		...
		},
		{
			...
			prompt: "Build a Rovo agent named Transcript Insights Reporter that turns meeting transcripts into decisions, insights, recommendations, owners, and follow-up action items.",
		...
		},
		{
			...
			prompt: "Build a Rovo agent named Meeting Insights that searches meeting notes, transcripts, and summaries to surface decisions, action items, highlights, and useful context.",
		...
		},
		{
			...
			prompt: "Build a Rovo agent named Trend Spotter that scans recent notes, transcripts, and feedback for emerging themes, leading indicators, and worth-watching shifts.",
			title: "Trend Spotter",
		},
		{
			...
			prompt: "Build a Rovo agent named Sentiment Mapper that clusters customer comments by sentiment, intent, and impact, then highlights the shifts that need a response.",
		...
		},
		{
			...
			layoutClassName: "",
			prompt: "Build a Rovo agent named Funnel Analyzer that examines event data and feedback to identify drop-off points, the most likely causes, and the next investigation step.",
		...
		},
		{
			...
			layoutClassName: "sm:col-span-2",
			prompt: "Build a Rovo agent named Research Synthesizer that pulls together notes, interviews, and reports into a single brief with insights, supporting quotes, and recommended decisions.",
	...
	brainstorm: [
		{
			...
			prompt: "Build a Rovo agent named Decision Director that reviews DACI decision documents, suggests improvements, identifies missing context, and points to useful resources.",
		...
		},
		{
			...
			prompt: "Build a Rovo agent named OKR Generator that creates effective OKRs from scratch, reviews draft OKRs, finds similar examples, and shares guidance for stronger objectives and key results.",
			title: "OKR Generator",
		},
		{
			...
			prompt: "Build a Rovo agent named Opportunity Explorer that expands a rough idea into distinct approaches, adjacent opportunities, risks, and the strongest path to investigate first.",
		...
		},
		{
			...
			prompt: "Build a Rovo agent named Experiment Planner that turns ideas into experiments with hypotheses, success criteria, owners, decision points, and next steps.",
		...
		},
		{
			...
			prompt: "Build a Rovo agent named Tradeoff Mapper that compares competing options by upside, cost, risk, reversibility, confidence, and team fit before recommending a direction.",
		...
		},
		{
			...
			layoutClassName: "sm:col-span-2",
			prompt: "Build a Rovo agent named Assumption Tester that lists likely failure modes, weak assumptions, unknowns, and the evidence that would change the recommendation.",
		...
		},
		{
			...
			layoutClassName: "",
			prompt: "Build a Rovo agent named Criteria Builder that defines must-haves, nice-to-haves, risks, disqualifiers, and a comparison rubric for evaluating options.",
	...
	review: [
		{
			...
			prompt: "Build a Rovo agent named Service Triage that triages service requests, recommends field updates, explains automation-ready output, and asks for missing details when needed.",
		...
		},
		{
			...
			prompt: "Build a Rovo agent named Service Request Helper that drafts responses using prior request insights, suggests assignees and skills, and summarizes requests for faster resolution.",
		...
		},
		{
			...
			prompt: "Build a Rovo agent named Rovo Ops that assists incident management, on-call duties, mitigation guidance, and faster detection, response, and recovery.",
			title: "Rovo Ops",
		},
		{
			...
			prompt: "Build a Rovo agent named Rovo Expert that introduces Rovo features, answers setup and usage questions, and shares helpful links for unlocking organizational knowledge.",
			title: "Rovo Expert",
		},
		{
			...
			layoutClassName: "lg:col-start-5 lg:row-start-2",
			prompt: "Build a Rovo agent named User Manual Writer that helps people write a friendly personal user manual covering working hours, preferred environments, communication norms, and collaboration tips.",
		...
		},
		{
			...
			layoutClassName: "sm:col-span-2",
			prompt: "Build a Rovo agent named Knowledge Base Guide that answers policy and process questions from trusted source context, cites useful references, and flags missing information.",
		...
		},
		{
			...
			layoutClassName: "",
			prompt: "Build a Rovo agent named Incident Recap Writer that turns incident channels, timelines, and notes into a recap with root causes, decisions, follow-ups, and owners.",
	...
	summarize: [
		{
			...
			layoutClassName: "sm:col-span-2 sm:row-span-2 lg:col-start-1 lg:col-span-2 lg:row-start-1 lg:row-span-2",
			prompt: "Build a Rovo agent named Product Requirements Guide that creates and reviews PRDs with direct language, customer empathy, supporting evidence, and actionable feedback.",
		...
		},
		{
			...
			prompt: "Build a Rovo agent named Release Notes Drafter that summarizes up to 20 Jira work items, groups them into themes, and drafts clear release notes for stakeholders.",
		...
		},
		{
			...
			layoutClassName: "lg:col-start-4 lg:col-span-2 lg:row-start-1",
			prompt: "Build a Rovo agent named Brand Voice Crafter that reviews or generates content against supplied brand voice and tone guidelines to help produce consistent communications.",
		...
		},
		{
			...
			layoutClassName: "lg:col-start-4 lg:row-start-2",
			prompt: "Build a Rovo agent named Social Media Writer that drafts social media posts, suggests more engaging variants, and adapts messaging for channel, audience, and tone.",
		...
		},
		{
			...
			layoutClassName: "lg:col-start-5 lg:row-start-2",
			prompt: "Build a Rovo agent named Global Translator that translates writing into most languages while preserving meaning, tone, and accessibility for speakers of other languages.",
		...
		},
		{
			...
			iconSrc: "/avatar-agent/service-agents/wildcard-5.svg",
			layoutClassName: "sm:col-span-2",
			prompt: "Build a Rovo agent named Executive Briefing Writer that condenses dense context into key points, decisions, risks, recommendations, and next steps for leadership.",
		...
		},
		{
			...
			layoutClassName: "",
			prompt: "Build a Rovo agent named Stakeholder Update Builder that summarizes progress, decisions, risks, blockers, and next steps in a concise update format.",
	...
	create: [
		{
			...
			prompt: "Build a Rovo agent named Work Item Planner that breaks big projects, epics, or streams of work into smaller actionable tasks, owners, sequencing, and next steps.",
		...
		},
		{
			...
			prompt: "Build a Rovo agent named Work Item Organizer that finds and updates project work items, moves them into sprints, assigns epics, deletes stale items, and recommends cleanup actions.",
		...
		},
		{
			...
			prompt: "Build a Rovo agent named Bug Report Assistant that turns issue context into clear, concise bug reports with reproduction details, impact, expected behavior, and triage-ready notes.",
		...
		},
		{
			...
			prompt: "Build a Rovo agent named Blocker Checker that detects work items likely to be blocked, explains the evidence, and recommends how to update or unblock the work.",
		...
		},
		{
			...
			prompt: "Build a Rovo agent named Readiness Checker that reviews a work item against a team's definition of ready and suggests fixes when required details are missing.",
		...
		},
		{
			...
			layoutClassName: "sm:col-span-2",
			prompt: "Build a Rovo agent named Progress Tracker that gives teams a real-time overview of in-flight projects, current priorities, owners, and what should be prioritized next.",
		...
		},
		{
			...
			iconSrc: "/avatar-agent/product-agents/wildcard-2.svg",
			layoutClassName: "",
			prompt: "Build a Rovo agent named Sprint Capacity Planner that recommends a balanced sprint scope based on team capacity, ticket sizes, prior velocity, and risk.",
