export type JiraGoldenJourneysV3PresentationChapter =
	| "track"
	| "learn"
	| "build"
	| "terminal";

export const JIRA_GOLDEN_JOURNEYS_V3_PRESENTATION_CHAPTERS = [
	...
	label: string;
	value: JiraGoldenJourneysV3PresentationChapter;
}[];
...
export {
	...
	JIRA_GOLDEN_JOURNEYS_V3_PAY_101_COMMIT_SHA,
