...
export function useTerminalDemo(enabled: boolean): TerminalDemoController {
	...
	}, [enabled, advance, stepBack, restart, moveSelection, state.dashboardVisible, selectedKey]);
