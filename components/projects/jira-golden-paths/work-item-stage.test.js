...
test("JGP Work item opens the experimental Agent Sessions design from its state buttons", () => {
...
test("JGP Work item renders a content-height inline surface with a viewport gutter", () => {
...
test("JGP Work item portals its local Rovo surface to viewport coordinates", () => {
...
test("JGP Work item can jump between all requested presets", () => {
	assert.match(
		STAGE_SOURCE,
