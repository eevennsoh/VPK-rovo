...
import { useAutoCycle } from "@/components/projects/jira-golden-journeys-v0/hooks/use-auto-cycle";
...
export default function AsxPage(): React.ReactElement {
	return (
		// The provider lives here (not only in the /jira-golden-journeys-v0 route layout) so the demo
		// works on every render path — the standalone route, the catalog
		// (`/components/projects/jira-golden-journeys-v0`), and preview (`/preview/projects/jira-golden-journeys-v0`).
