...
const TERMINAL_HOOK_SOURCE = fs.readFileSync(
	path.join(process.cwd(), "components/projects/jira-golden-journeys-v0/hooks/use-terminal-demo.ts"),
	"utf8",
);
const TERMINAL_JIRA_PANE_SOURCE = fs.readFileSync(
	path.join(process.cwd(), "components/projects/jira-golden-journeys-v0/components/terminal-stage-jira-pane.tsx"),
	"utf8",
);
const TERMINAL_PAGE_SOURCE = fs.readFileSync(
	path.join(process.cwd(), "components/projects/jira-golden-journeys-v0/page.tsx"),
	"utf8",
);
...
const TERMINAL_CHROME_SOURCE = fs.readFileSync(
	path.join(process.cwd(), "components/projects/jira-golden-journeys-v0/components/terminal-stage-chrome.tsx"),
	"utf8",
);
const TERMINAL_CLAUDE_PANE_SOURCE = fs.readFileSync(
	path.join(process.cwd(), "components/projects/jira-golden-journeys-v0/components/terminal-stage-claude-pane.tsx"),
	"utf8",
);
