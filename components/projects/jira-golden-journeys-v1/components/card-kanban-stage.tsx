...
} from "@/components/projects/jira-golden-journeys-v1/data/card-kanban-data";
import {
	createJgpKanbanActivity,
	getJgpGenerativeAgentSelection,
} from "@/components/projects/jira-golden-journeys-v1/data/kanban-data";
import type { UseAutoCycleResult } from "@/components/projects/jira-golden-journeys-v1/hooks/use-auto-cycle";
...
/**
 * The "Card Kanban" design pattern for the Jira Golden Journeys v1 gallery.
 *
