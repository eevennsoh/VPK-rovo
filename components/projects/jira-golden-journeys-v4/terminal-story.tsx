...
export interface JiraGoldenJourneysV4TerminalStoryProps {
...
export function JiraGoldenJourneysV4TerminalStory({
	controller,
	promptCopied = false,
	resetKey,
	theme = "dark",
}: Readonly<JiraGoldenJourneysV4TerminalStoryProps>): React.ReactElement {
