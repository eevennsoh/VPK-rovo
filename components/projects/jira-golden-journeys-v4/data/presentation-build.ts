...
export const JIRA_GOLDEN_JOURNEYS_V4_PAY_101_SESSION_ID = "pay-101-inventory-claude-session";
export const JIRA_GOLDEN_JOURNEYS_V4_PAY_101_UNCAPTURED_SESSION_ID = "lw-scope-thread";
export const JIRA_GOLDEN_JOURNEYS_V4_PAY_101_PULL_REQUEST_NUMBER = 1839;
export const JIRA_GOLDEN_JOURNEYS_V4_PAY_101_COMMIT_SHA = "8c2f4e1";
...
export const PAY_101_INVENTORY_PR_ARTIFACT: ArtifactListItem = {
	...
	pullRequest: {
		number: JIRA_GOLDEN_JOURNEYS_V4_PAY_101_PULL_REQUEST_NUMBER,
		status: "Merged",
		additions: 312,
		deletions: 8,
	},
...
export const PAY_101_INVENTORY_COMMIT_ARTIFACT: ArtifactListItem = {
	...
	owner: "Maya Ferreira",
	logoName: "github",
	href: `https://github.com/${PAY_REPOSITORY}/commit/${JIRA_GOLDEN_JOURNEYS_V4_PAY_101_COMMIT_SHA}`,
};
...
export const JIRA_GOLDEN_JOURNEYS_V4_PAY_101_WORK_ITEM: WorkItemData = {
	code: "PAY-101",
...
function createPay101ContextResources(): JiraWorkItemState["contextResources"] {
	return {
		title: JIRA_GOLDEN_JOURNEYS_V4_PAY_101_WORK_ITEM.title,
		description: PAY_101_DESCRIPTION,
		tldr: [
...
export function createJiraGoldenJourneysV4Pay101BuildState(): JiraWorkItemState {
	const base = hydratePreset("filled", JIRA_GOLDEN_JOURNEYS_V4_PAY_101_WORK_ITEM);
