...
const JIRA_GOLDEN_JOURNEYS_V4_BASE_URL = "https://jira-golden-journeys-v4.atlassian.net";

export const JIRA_GOLDEN_JOURNEYS_V4_RESUME_PROMPT =
	"cd /Users/venn/dev/payments/.worktrees/pay-101-adapter && claude --resume 338eaaca-62da-4dcb-925b-f2c5f16be5a8";

export function getJiraGoldenJourneysV4IssueUrl(issueKey: string): string {
	return `${JIRA_GOLDEN_JOURNEYS_V4_BASE_URL}/browse/${encodeURIComponent(issueKey)}`;
}

export const JIRA_GOLDEN_JOURNEYS_V4_TERMINAL_BEATS: readonly TerminalBeat[] = [
	{
		...
		steps: [
			{
				kind: "paste",
				pane: "right",
				text: JIRA_GOLDEN_JOURNEYS_V4_RESUME_PROMPT,
			},
...
export const JIRA_GOLDEN_JOURNEYS_V4_TERMINAL_STEP_COUNT =
	JIRA_GOLDEN_JOURNEYS_V4_TERMINAL_BEATS.length + 1;

export const JIRA_GOLDEN_JOURNEYS_V4_TERMINAL_STORY = {
	beats: JIRA_GOLDEN_JOURNEYS_V4_TERMINAL_BEATS,
	layout: "claude-only",
	...
	getIssueUrl: getJiraGoldenJourneysV4IssueUrl,
	frameAriaLabel: "Paste the copied resume prompt for PAY-101",
	dashboard: {
		title: "Jira work item",
		workspace: "Jira Golden Journeys v4 · PAY-101",
