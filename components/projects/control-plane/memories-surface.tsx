...
// oxlint-disable react-doctor/jsx-max-depth -- This dense demo/control surface keeps conditional rendering localized to preserve the existing screen contract.
