...
function Input({
	...
	return (
		<InputPrimitive
			...
			className={cn(
				"placeholder:text-muted-foreground focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 aria-invalid:border-destructive user-invalid:ring-destructive/20 user-invalid:border-destructive h-8 w-full min-w-0 rounded-lg border border-transparent bg-transparent px-2.5 py-1 text-sm transition-colors file:inline-flex file:h-6 file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground focus-visible:ring-3 aria-invalid:ring-3 user-invalid:ring-3 outline-none disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-(--opacity-disabled) read-only:cursor-default read-only:border-transparent read-only:bg-transparent read-only:hover:border-transparent read-only:hover:bg-transparent read-only:focus-visible:border-transparent read-only:focus-visible:ring-0",
