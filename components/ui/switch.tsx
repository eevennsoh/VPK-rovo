...
export interface SwitchIndicatorProps extends Omit<ComponentProps<"span">, "children"> {
	checked: boolean
	size?: SwitchSize
}

function SwitchStateIcons() {
	return (
		<>
			<Icon
				aria-hidden="true"
				...
				label="Off"
				className={switchOffIconClassName}
			/>
			<Icon
				aria-hidden="true"
				render={<CheckMarkIcon label="" size="small" color="currentColor" />}
				label="On"
				className={switchOnIconClassName}
			/>
		</>
	)
}
...
function SwitchIndicator({
	...
	return (
		<span
			...
			data-size={size}
			className={cn(switchRootClassName, "pointer-events-none", className)}
		>
			<SwitchStateIcons />
			<span
				data-checked={checked ? "" : undefined}
