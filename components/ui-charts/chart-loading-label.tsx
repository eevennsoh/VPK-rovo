...
import { ShimmeringText } from "@/components/ui-charts/shimmering-text";
...
export function ChartLoadingLabel({
  ...
  return (
    ...
    >
      <ShimmeringText
        className="font-medium text-sm tracking-wide [--color:var(--chart-foreground-muted)] [--shimmering-color:var(--chart-foreground)]"
        text={text}
      />
    </motion.div>
  );
